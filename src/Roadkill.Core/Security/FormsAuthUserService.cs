    ...
    public class FormsAuthUserService : UserServiceBase
    {
        ...
        public override string Signup(UserViewModel model, Action completed)
        {
            ...
            try
            {
                ...
                User user = new User();
                user.Username = model.NewEmail.ToLower();
        ...
        public override bool UpdateUser(UserViewModel model)
        {
            try
            {
                User  user = Repository.GetUserByEmail(model.ExistingEmail);
                model.NewEmail = model.NewEmail.ToLower();
                model.ExistingEmail = model.ExistingEmail.ToLower();
