...
namespace Roadkill.Core.Services
{
    public interface IPageService
    {
        ...
        void SendProjectTagMatchEmail(int pageId, int projectId, string projectTitle, List<PageViewModel> matchedProjects, string tags,ProjectTagMatchEmail _projectTagMatchEmail);
